...
cd /d "%~dp0"
title OPEN NIGHT v3.0 - Grid Client
...
echo Open Night v3.0 GridWorld-authoritative desktop client starting...
echo Ground, minimap, and M map use GridWorld; legacy place names may remain as labels only.
echo Discovered multiplayer servers must advertise the same v3.0 wire version before JOIN.
