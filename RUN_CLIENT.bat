...
cd /d "%~dp0"
title OPEN NIGHT v1.9 - Grid Client
...
echo Open Night v1.9 GridWorld-authoritative desktop client starting...
echo Ground, minimap, and M map use GridWorld; legacy place names may remain as labels only.
echo Discovered multiplayer servers must advertise the same v1.9 wire version before JOIN.
