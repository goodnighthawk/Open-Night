...
cd /d "%~dp0"
title OPEN NIGHT v2.4 - Grid Client
...
echo Open Night v2.4 GridWorld-authoritative desktop client starting...
echo Ground, minimap, and M map use GridWorld; legacy place names may remain as labels only.
echo Discovered multiplayer servers must advertise the same v2.4 wire version before JOIN.
