...
cd /d "%~dp0"
title OPEN NIGHT v1.1 - Grid Client
...
echo Open Night v1.1 GridWorld-authoritative desktop client starting...
echo Ground, minimap, and M map use GridWorld; legacy place names may remain as labels only.
echo Discovered multiplayer servers must advertise the same v1.1 wire version before JOIN.
