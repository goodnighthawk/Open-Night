...
cd /d "%~dp0"
title OPEN NIGHT v1.2 - Grid Client
...
echo Open Night v1.2 GridWorld-authoritative desktop client starting...
echo Ground, minimap, and M map use GridWorld; legacy place names may remain as labels only.
echo Discovered multiplayer servers must advertise the same v1.2 wire version before JOIN.
