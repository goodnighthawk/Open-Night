...
def main() -> None:
    ...
    require(version_label() == "Open Night v1.4", version_label())
    ...
    require("PYMMO_PATCH_ID=open-night-v1.4" in railway,
            "Railway patch id is not v1.4")
    ...
    require("server_name,Open Night v1.4" in server_config,
            "repo-local server default is not v1.4")
    require("OPEN NIGHT v1.4" in read("RUN_CLIENT.bat"),
            "desktop client launcher label is stale")
    run_server = read("RUN_SERVER.bat")
    require("OPEN NIGHT v1.4" in run_server,
    ...
    audit = {
        ...
        "railway_patch_id": "open-night-v1.4",
