...
def main() -> int:
    ...
    assert 'command == "/bug"' in client and 'source="chat_/bug"' in client
    assert "feedback\\\\next_version" in client and "/bug description" in client
    ...
    print("  /bug CSV + PNG capture and mouse-head removal verified")
    return 0
