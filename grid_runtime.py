...
def grid_network_metadata(map_config: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "generated_layers": list(world.layers),
        "blank_layers": [layer for layer in ["underground", "first_floor", "second_floor", "hell", "clouds", "hud_space"] if layer not in world.layers],
