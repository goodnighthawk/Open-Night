...
echo.
echo ==============================================================
echo   Open Night v0.8.0 - full Pygame browser client
echo ==============================================================
...
echo.
".venv\Scripts\python.exe" -m pygbag --app_name open-night --package open-night-v0-8-0 --title "Open Night v0.8.0" --version 0.9.2 --port 8000 --ume_block 0 --disable-sound-format-error "%WEB_STAGE%"
set "RC=%ERRORLEVEL%"
