...
:main
echo ============================================================
echo   OPEN NIGHT v0.7.3 // RAILWAY SERVER UPDATE
echo ============================================================
echo.
...
:deploy
echo.
echo Uploading the current Open Night v0.7.3 folder to Railway...
echo This updates the existing internet server and keeps its public domain.
echo Patch v0.7.3 resets prototype MySQL data once, then preserves it across restarts.
echo.
pause
call railway.cmd up
